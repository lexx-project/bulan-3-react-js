    ...
    <>
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4 text-center">
        ...
        <button className="mt-5">
          <Link
            to="/"
            className="group relative inline-block text-sm font-medium text-primary focus:outline-none focus:ring active:text-primary-foreground"
          >
            ...
            <span className="relative block border border-current bg-background px-8 py-3">
              Go Home
            </span>
          </Link>
        </button>
